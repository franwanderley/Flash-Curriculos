...
--
-- Host: 127.0.0.1
-- Generation Time: 20-Jan-2020 às 04:15
...
--
-- Estrutura da tabela `area_de_interesse`
--
...
--
-- Extraindo dados da tabela `area_de_interesse`
--

INSERT INTO `area_de_interesse` (`id`, `descricao`) VALUES
(1, 'TI'),
(2, 'GASTRONOMIA'),
(3, 'NUTRIÇÃO'),
(4, 'ENGENHARIA CIVIL'),
...
--
-- Estrutura da tabela `area_e_curriculo`
--

CREATE TABLE `area_e_curriculo` (
  `id` int(11) NOT NULL,
  `areadeinteresses_id` int(11) NOT NULL,
  `curriculo_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `area_e_curriculo`
--

INSERT INTO `area_e_curriculo` (`id`, `areadeinteresses_id`, `curriculo_id`) VALUES
(1, 1, 1),
(2, 2, 1),
(3, 3, 2),
(4, 2, 3),
...
CREATE TABLE `candidato` (
  ...
  `possuiDeficiencia` char(1) DEFAULT NULL,
  `tipoDeficiencia` varchar(100) DEFAULT NULL,
  `avaliacao` int(11) DEFAULT NULL,
  `email` varchar(100) DEFAULT NULL,
  `senha` varchar(100) DEFAULT NULL,
  `cidade_id` bigint(20) UNSIGNED NOT NULL,
  `curriculo_id` bigint(20) UNSIGNED NOT NULL,
  `link_google` varchar(100) DEFAULT NULL,
...
INSERT INTO `candidato` (`foto`, `id`, `nome`, `nomePai`, `nomeMae`, `rg`, `cpf`, `dataNascimento`, `sexo`, `estadoCivil`, `endereco`, `cep`, `numeroCasa`, `complemento`, `telefone`, `fone`, `possuiDeficiencia`, `tipoDeficiencia`, `avaliacao`, `email`, `senha`, `cidade_id`, `curriculo_id`, `link_google`, `link_instagram`, `link_facebook`, `link_linkedin`, `reputacao`) VALUES
('agronomo.jpg', 3, 'LILIAN', 'Mateus Fernande', 'NazarÃ© Pimenta', '22222', '654.654.654', '1998-07-02', 'F', 'SOLTEIRO', 'RUA ABC', '67888-000', 13, 'CASA', '(88)9.9462-1918', NULL, '0', 'PROBLEMA DE COLUNA', 6, 'LILIAN@HTOMAIL.COM', '123456', 756, 2, NULL, NULL, NULL, NULL, NULL),
('app/images/candidato/agronomo.jpg', 4, 'MATEUS SILVA PEREIRA', 'JOÃO DOS SANTOS', 'MARTA MARIA SILVA', '3129341234', '412341234', '1970-10-08', 'M', 'SOLTEIRO', 'RUA DAS FLORES', '62170000', 67, 'ALUGADA', '8899999999', '', 'N', '', 0, 'teste01@gmail.com', '123456', 1, 3, '', '', '', '', NULL),
('app/images/candidato/agronomo.jpg', 5, 'JONAS SILVA PEREIRA', 'CARLOS DOS SANTOS', 'JOANA MARIA SILVA', '2341235', '1234512354', '2000-10-24', 'M', 'SOLTEIRO', 'RUA DAS PRAÇAS', '62170000', 67, 'ALUGADA', '8899999999', '', 'N', '', 0, 'teste02@gmail.com', '123456', 1, 4, '', '', '', '', NULL),
('app/images/candidato/agronomo.jpg', 6, 'JOSÉ SILVA PEREIRA', 'Rodrigo Oliveira Silva', 'JOANA MARIA SILVA', '2341235', '1234512354', '2005-10-24', 'M', 'SOLTEIRO', 'RUA DAS PRAÇAS', '62170000', 67, 'ALUGADA', '8899999999', '', 'N', '', 0, 'teste03@gmail.com', '123456', 1, 5, '', '', '', '', NULL),
('app/images/candidato/agronomo.jpg', 7, 'MARIA SILVA PEREIRA', 'MURILO DOS SANTOS', 'CARLA MARIA SILVA', '1241234123', '123412343', '1998-10-24', 'F', 'SOLTEIRA', 'RUA DAS PRAÇAS', '62170000', 67, 'ALUGADA', '8899999999', '', 'N', '', 0, 'teste03@gmail.com', '123456', 2, 6, '', '', '', '', NULL),
('app/images/candidato/agronomo.jpg', 8, 'Lucas de Lima Sousa', 'Antonio Edvar', 'Maria Diva', '00000000', '00000000', '2009-11-21', 'M', 'Solteiro', 'Rua Cesário Custódio', '62170000', 98, 'Alugada', '994986436', '', 'N', '', 0, 'lucaslima211996@gmail.com', '123456', 817, 7, '', '', '', '', NULL),
('app/images/candidato/agronomo.jpg', 9, 'Marcos Macedo SIlva', 'Carlos Eduardo', 'Maria joice', '', '', '1996-10-28', 'M', 'SOLTEIRO', '', '62170000', 0, 'Alugada', '999999999', '', 'N', '', 0, 'marcos1231@gmail.com', '123456', 17, 9, '', '', '', '', NULL),
('app/images/candidato/agronomo.jpg', 10, 'Juvenal silva rodrigues', 'Mateus MarinhoEduardo', 'Maria Arruda Silva', '', '', '1980-10-28', 'M', 'SOLTEIRO', '', '62170000', 0, 'Alugada', '999999999', '', 'N', '', 0, 'juvenal1231@gmail.com', '123456', 60, 10, '', '', '', '', NULL),
('app/images/candidato/agronomo.jpg', 13, 'carla silva rodrigues', 'Marcelo arruda', 'Monica Arruda Silva', '', '', '1979-10-28', 'F', 'SOLTEIRO', '', '62170000', 0, 'Alugada', '999999999', '', 'N', '', 0, 'carla231@gmail.com', '123456', 45, 9, '', '', '', '', NULL),
('app/images/candidato/agronomo.jpg', 14, 'Marcia Santos Rodrigues', 'Mauricio Braga', 'Monica sousa', '', '', '2000-10-01', 'F', 'SOLTEIRA', '', '', 0, '', '', '', '', '', 0, 'marcia@gmail.com', '123456', 56, 8, '', '', '', '', NULL),
('app/images/candidato/agronomo.jpg', 15, 'Fabricia Rodrigues Silva', 'Fernado Mardonio Silva', 'Maria mirandeira', '', '', '1994-10-27', 'F', 'SOLTEIRA', '', '', 0, '', '', '', '', '', 0, 'fabricia@gmail.com', '123456', 34, 5, '', '', '', '', NULL),
('app/images/candidato/agronomo.jpg', 16, 'Fabio Cardoso Lima', 'Fernado Mardonio Silva', 'Maria mirandeira', '', '', '1990-10-25', 'M', 'SOLTEIRO', '', '', 0, '', '', '', '', '', 0, 'fabio@gmail.com', '123456', 34, 4, '', '', '', '', NULL),
('app/images/candidato/agronomo.jpg', 17, 'Pedrinho Junio Rocha', 'Pedro Rocha', 'Maria Rocha', '', '', '1990-10-25', 'M', 'SOLTEIRO', '', '', 0, '', '', '', '', '', 0, 'rocha@gmail.com', '123456', 34, 4, '', '', '', '', NULL),
('app/images/candidato/21/cj.jpg', 21, 'Lucas de Lima Sousaaa', 'Antônio Edvar SIlva Sousa', 'Maria DIva de Lima', '0000000000', '00000000000', '1996-11-21', 'M', 'SOLTEIRO', 'Rua Cesário Custódio', '62170000', 96, 'Alugada', '+5588994986436', NULL, 'N', NULL, 0, 'lucaslima211996@gmail.com', NULL, 817, 1, NULL, NULL, NULL, NULL, 0),
('app/images/candidato/edmara.jpg', 22, 'Francisca Edmara de Lima Sousa', 'Antônio Edvar SIlva Sousa', 'Maria DIva de Lima', '0000000000', '00000000000', '2000-02-23', 'F', 'SOLTEIRA', 'Rua Cesário Custódio', '62170000', 96, 'Alugada', '+5588994986436', '', 'N', '', 0, 'edmaralima148@gmail.com', '123456', 817, 1, '', '', '', '', 0),
('app/images/candidato/fabiana.jpg', 23, 'Maria Fabiana Melo de Sousa', 'Antônio Parente de Sousa', 'Maria Elena Melo Freire', '0000000000', '00000000000', '2000-07-14', 'F', 'SOLTEIRA', 'Vila Betania', '62170000', 0, 'Alugada', '+5588994986436', '', 'N', '', 0, 'fabyanajackson@gmail.com', '123456', 817, 1, '', '', '', '', 0),
('app/images/candidato/Wanderley.jpg', 24, 'Wanderley', 'Pai do Wanderley', 'Mãe do Wanderley', '0000000000', '00000000000', '2000-07-14', 'M', 'SOLTEIRO', 'Rua de Sobral', '62170000', 0, 'Alugada', '+5588994986436', '', 'N', '', 0, 'wanderley3101@gmail.com', '123456', 817, 1, '', '', '', '', 0),
('app/images/candidato/herson.jpg', 25, 'Herson Martins', 'Pai do Herson', 'Mãe do Herson', '00000000000', '00000000000', '2019-12-01', 'M', 'CASADO', 'Rua de Sobral', '000000000', 0, '', '', '', 'N', '', 0, 'herson.computer@gmail.com', '123456', 864, 1, '', '', '', '', 0),
('app/images/candidato/thayna.jpg', 26, 'Thayna Jorge Teodoro', 'Benedito', 'Lucileide', '0000000000', '0000000000', '2019-01-06', 'F', 'SOLTEIRA', 'Rua 12 de Dezembro', '62170000', 0, '', '', '', '', '', 0, 'thaynadlimajorge@gmail.com', '123456', 817, 1, '', '', '', '', 0),
('app/images/candidato/20180203_134356.jpg', 27, 'deborah', 'pai deborah', 'maedeborah', '2009', '030.283.623-33', '2020-01-13', 'F', 'CASADO', 'rua 123', '62280-000', 10, 'casa', '(88)9.9462-1918', NULL, NULL, NULL, NULL, 'suprem_son@hotmail.com', '123', 864, 13, 'google.deb', NULL, 'face.deb', NULL, NULL),
('app/images/candidato/ch.jpg', 28, 'mirian', 'paimirian', 'maemirian', '2001', '030.283.623-33', '2020-01-13', 'F', 'CASADO', 'rua ami', '62280-000', 123, 'casa', '(88)3.3628-0120', NULL, '0', NULL, NULL, 'mirian@gmail.com', '123', 864, 14, NULL, NULL, NULL, NULL, NULL),
('app/images/candidato/Dasciolo.jpg', 29, 'ricar', 'paidor', 'maedor', '123131', '030.283.623-33', '2020-01-12', 'M', 'CASADO', 'rua1', '99999-999', 99, 'iwqwiu', '(88)9.9462-1918', NULL, '0', NULL, NULL, 'teste@gmail', '123', 86, 16, 'google.ric', NULL, NULL, NULL, NULL),
('app/images/candidato/Dasciolo.jpg', 30, 'MARCOSpoi', 'PAIMARCOSpoi', 'MAEMARCOSpoi', '20002020020202', '030.283.623-33', '2020-01-18', 'M', 'CASADO', 'RUA 1', '99999-999', 123, 'CASA 1', '(99)9.9999-9999', '(88)8.8888-8888', '0', NULL, NULL, 't1@gmail.com', '123', 864, 17, 'google.marcos', 'insta.marcos', 'face.marcos', 'linke.marcos', NULL);
...
INSERT INTO `cidade` (`id`, `nome_cidade`, `estado_id`) VALUES
(1, 'Afonso Cláudio', 8),
...
INSERT INTO `curriculo` (`id`, `pretensaoSalarial`) VALUES
(1, 2000),
(2, 3000),
(3, 4000),
(4, 4000),
...
--
-- Estrutura da tabela `cursos_complementares`
--

CREATE TABLE `cursos_complementares` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Extraindo dados da tabela `cursos_complementares`
--

INSERT INTO `cursos_complementares` (`id`, `decricao`, `instituicao`, `cargaHoraria`, `dataComeco`, `dataFim`, `curriculo_id`) VALUES
(1, 'programação em php', 'educa mais', 40, '2019-03-01', '2019-03-14', 1),
(2, 'culinária', 'ifce', 20, '2019-07-01', '2019-07-02', 2),
(3, 'programação linear', 'ueva', 60, '2019-07-01', '2019-07-02', 3),
(4, 'curso de administração', 'ueva', 80, '2019-07-01', '2019-07-03', 5),
(9, 'RECEPCAO', 'EMPRESA_E_VC', 100, '2020-01-12', '2020-01-12', 13),
(10, 'JAVA', 'EMPRESA1', 150, '2020-01-12', '2020-01-12', 16),
(14, 'jquery', 'cursos&jquery', 100, '2020-01-01', '2020-01-02', 17);
...
INSERT INTO `experiencia_profissional` (`id`, `cargo`, `empresa`, `detalhes`, `dataComeco`, `dataFim`, `curriculo_id`) VALUES
(2, 'PROGRAMADOR DE BRINQUEDOS', 'BRINKS', 'FAZIA A PROGRAMAÇÃO NOS BONECOS DA STAR', '2019-08-01', '2019-08-02', 2),
(3, 'PROFESSOR', 'INFOTEC', 'Aulas de informática', '2018-09-01', '2019-09-07', 1),
(4, 'PROFESSOR', 'INFOTEC', 'Aulas de informática', '2018-09-01', '2019-09-07', 2),
(5, 'PROFESSOR', 'INFOTEC', 'Aulas de informática', '2018-09-01', '2019-09-07', 3),
(6, 'recepcionista', 'tulip', 'show de bola', '2020-01-01', '2020-01-02', 1),
(7, 'faxineiro', 'jm carros', 'mais ou menos', '2020-01-01', '2020-01-07', 1),
(20, 'RECEPCIONISTA', 'HOTEL LAZER', 'FOILEGAL', '2020-01-12', '2020-01-12', 13),
(21, 'CARGO DE FAXINEIRO', 'EMPRESA1', 'FOI MAIS OU MENOS', '2020-01-12', '2020-01-12', 16),
(22, 'ANALISTA', 'EMPRESASOFT', 'FOI LEGAL', '2020-01-18', '2020-01-18', 17),
(23, 'gerente', 'empresa2', 'foi bacana', '2020-01-19', '2020-01-19', 17);
...
CREATE TABLE `formacao` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `instituicao` varchar(100) DEFAULT NULL,
  `grauDeEscolaridade` varchar(100) DEFAULT NULL,
  `dataComeco` date DEFAULT NULL,
  `dataFim` date DEFAULT NULL,
...
INSERT INTO `formacao` (`id`, `instituicao`, `grauDeEscolaridade`, `dataComeco`, `dataFim`, `curso_id`, `curriculo_id`) VALUES
(1, 'ueva', 'ANDAMENTO', '2019-06-01', '2019-07-22', 1, 1),
(2, 'ueva', 'ANDAMENTO', '2019-01-01', '2019-02-28', 3, 3),
(7, 'UEVA', 'SUPERIOR', '2020-01-12', '2020-01-12', 3, 13),
(8, 'UFC', 'POS-GRADUADO', '2020-01-12', '2020-01-12', 3, 13),
(9, 'UEVA', 'FUNDAMENTAL', '2020-01-12', '2020-01-12', 2, 16),
(10, 'UEVA', 'SUPERIOR', '2020-01-18', '2020-01-18', 1, 17);
...
INSERT INTO `funcionario` (`id`, `nome`, `email`, `telefone`, `senha`, `foto`, `tipo_usuario`) VALUES
(1, 'wandercreyson', 'wander@gmail.com', '88-994622030', '123456789', 'app/images/funcionarios/c1.jpg', 'FUNCIONARIO'),
(2, 'wanda', 'wanda@gmail.com', '88-984625159', '54321', 'app/images/funcionarios/c1.jpg', 'FUNCIONARIO'),
(3, 'FROIDCREYSON', 'froid@gmail.com', '88-994621918', '12345678', 'app/images/funcionarios/3/lucas.jpg', 'ADMINISTRADOR');
...
CREATE TABLE `laudo` (
  ...
  `descricao` text,
  `selecionados` tinyint(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `laudo` (`id`, `candidato_id`, `vaga_id`, `descricao`, `selecionados`) VALUES
(1, 1, 2, 'bom candidato....talvez deva melhorar isso e aquilo.', 0),
(2, 1, 2, 'laudo teste apenas....', 0),
(4, 3, 4, 'Teste2 criado por Lucas para laudo', 0),
(6, 5, 4, 'Teste3 criado por Lucas para laudo', 0),
(7, 6, 4, 'Teste5 criado por Lucas para laudo', 1),
(9, 22, 41, '', 0),
(10, 23, 41, '', 0),
(11, 24, 41, '', 0),
(12, 25, 41, '', 0),
...
--
-- Estrutura da tabela `nivel_idioma`
--
...
--
-- Extraindo dados da tabela `nivel_idioma`
--

INSERT INTO `nivel_idioma` (`id`, `curriculo_id`, `idioma_id`, `nivel`) VALUES
(1, 1, 1, 'BASICO'),
(2, 1, 3, 'AVANCADO'),
(3, 3, 5, 'intermediario'),
(4, 4, 7, 'avancado'),
...
(7, 1, 7, 'BASICO'),
(20, 13, 1, 'AVANCADO'),
(21, 13, 3, 'INTERMEDIARIO'),
(22, 14, 1, 'BASICO'),
(23, 14, 5, 'BASICO'),
(24, 16, 1, 'BASICO'),
(25, 16, 2, 'INTERMEDIARIO');
...
CREATE TABLE `vaga` (
  ...
  `mediaSalarial` float DEFAULT NULL,
...
INSERT INTO `vaga` (`id`, `titulo`, `foto`, `nomeEmpresa`, `requisitosMinimos`, `mediaSalarial`, `jornada`, `descricao`, `status`, `beneficios`) VALUES
(4, 'Agronomo', 'app/images/vagas/nature4.jpg', 'AgroNegócio SA', 'Formação Completa em Agronomia;\r\nExperiência em vendas comprovada nas culturas de Soja, Trigo e Feijão; Participação em eventos agrí­colas; \r\nParticipação no desenvolvimento de mercado em clientes e parceiros comerciais; \r\nDisponibilidade de viagens e treinamento comerciais;\r\nDesenvolver clientes atuais e prospectar novos parceiros;\r\nHabilidade de apresentações e uso de software.', 10, 50, 'Conhecer técnicas secretas da roça!', 'ABERTA', 'beneficios do agronomo asdf'),
(5, 'automóveis', 'app/images/vagas/AUTO.jpg', 'AutoSonhos', NULL, 2000, 600, NULL, 'ABERTA', NULL),
(6, 'Confeiteiro', 'app/images/vagas/confeiteiro.jpeg', 'ConfAnça', '', 1500, 60, '', 'ABERTA', NULL),
(7, 'Padeiro', 'app/images/vagas/padeiro.jpg', 'ConfAnça', '', 8000, 60, '', 'ABERTA', NULL),
(8, 'Pedreiro', 'app/images/vagas/pedreiro.jpg', 'ConfAnça', '', 1800, 50, '', 'ABERTA', NULL),
(9, 'Veterinário', 'app/images/vagas/vet.jpg', 'VetRações', '', 3000, 50, '', 'ABERTA', NULL),
(10, 'Web Designer', 'app/images/vagas/webD.jpeg', 'AcerolaComp', '', 5000, 50, '', 'ABERTA', NULL),
(11, 'Zelado', 'app/images/vagas/zelador.jpg', 'ZelAqui', '', 900, 50, '', 'ABERTA', NULL),
(29, 'Programação', NULL, 'Elite Educação', 'Ensino Superiro Completo em Ciências da Computação', 1500, 40, 'Atuar como programador ', 'ABERTA', NULL),
(31, 'Analista de Dados', NULL, 'Centec Info', 'Conhecimento prévio em programação', 1700, 40, 'Atuar como estagiário', 'ABERTA', NULL),
(34, 'Cozinheiro', NULL, 'Vilabar', 'Ensino médio concluido', 900, 40, 'Saber cozinhar ', 'ABERTA', NULL),
(35, 'Agronomo', 'app/images/vagas/agronomo.jpg', 'AgroNegócio SA', 'FormaÃ§Ã£o completa em Agronomia; ExperiÃªncia em vendas comprovada nas culturas de Soja, Trigo e FeijÃ£o; ParticipaÃ§Ã£o em eventos agrÃ­colas; ParticipaÃ§Ã£o no desenvolvimento de mercado em clientes e parceiros comerciais; Disponibilidade de viagens e treinamento comerciais; Desenvolver clientes atuais e prospectar novos parceiros; Habilidade de apresentaÃ§Ãµes e uso de software.', 1000, 40, 'DescriÃ§Ã£o da vaga de Agronomo', 'ABERTA', NULL),
(36, 'Gerente Administrativo', NULL, 'Mucambo SA', 'Ensino médio concluido', 2000, 40, 'Exigimos experiência na área', 'ABERTA', NULL),
(39, 'Agente do FBI', 'app/images/vagas/ESSENCIAL.jpg', 'FBI', 'Policial federal', 50, 20, 'Ser doidão', 'ABERTA', 'beneficios da vaga 39 ok'),
(41, 'Programador Criativo', 'app/images/vagas/prog.jpg', 'ProWork', 'PHP e Java', 2000, 40, 'Saiba fazer café ', 'FECHADA', NULL),
(44, 'CAPINEIRO', 'app/images/vagas/ESSENCIAL.jpg', 'CAPINEAQUI', 'SABER CAPINAR', 10000, 100, 'descricao capinar', 'ABERTA', 'beneficios capinar'),
(45, 'MANOBRISTA', 'app/images/vagas/AUTO.jpg', 'MANOBREBEM', 'SABER DIRIGIR', 1000, 100, 'MUITO BOM... ', 'ABERTA', 'VALE ALIMENTACAO'),
(54, NULL, 'app/images/vagas/', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(55, 'automóveis', 'app/images/vagas/AUTO.jpg', 'AutoSonhos', NULL, 20, 600, NULL, NULL, NULL),
(56, 'automóveis', 'app/images/vagas/RESTAURANTE.jpg', 'AutoSonhos', NULL, 20, 600, NULL, NULL, NULL),
(57, NULL, 'app/images/vagas/', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(58, 'bancario', 'app/images/vagas/BAKER.jpg', 'bando real', 'formação em economia', 10000, 48, 'ótimo emprego', NULL, 'vale tudo.'),
(59, 'bancario', 'app/images/vagas/BAKER.jpg', 'banco real', 'economes', 20000, 200, 'legal', NULL, 'vale tudo'),
(60, NULL, 'app/images/vagas/', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(61, 'asdf', 'app/images/vagas/', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(62, 'pad', 'app/images/vagas/PADARIA.jpg', 'padempresa', 'padrequisssitos', 1234.11, 23, 'adasfasdadad', NULL, 'beneficios asdf'),
(63, NULL, 'app/images/vagas/', NULL, 'asdf', NULL, NULL, NULL, NULL, NULL),
(64, 'hugeiro', 'app/images/vagas/BAKER.jpg', 'banker hug', 'ser hugado', 123131, 200, 'legal', NULL, 'vale tudo'),
(65, 'BANQUEIRO', 'app/images/vagas/BAKER.jpg', 'BANKER', 'FORMACAO EM ECONOMIA', 123.45, 123, 'LEGAL', NULL, 'VALE TUDO'),
(66, 'Agronomo', 'app/images/vagas/nature1.jpg', 'AgroNegócio SA', 'Formação Completa em Agronomia;\r\nExperiência em vendas comprovada nas culturas de Soja, Trigo e Feijão; Participação em eventos agrí­colas; \r\nParticipação no desenvolvimento de mercado em clientes e parceiros comerciais; \r\nDisponibilidade de viagens e treinamento comerciais;\r\nDesenvolver clientes atuais e prospectar novos parceiros;\r\nHabilidade de apresentações e uso de software.', 10, 50, 'Conhecer técnicas secretas da roça!', NULL, 'beneficios do auto b'),
(67, 'Agronomo', 'app/images/vagas/AUTO.jpg', 'AgroNegócio SA', 'Formação Completa em Agronomia;\r\nExperiência em vendas comprovada nas culturas de Soja, Trigo e Feijão; Participação em eventos agrí­colas; \r\nParticipação no desenvolvimento de mercado em clientes e parceiros comerciais; \r\nDisponibilidade de viagens e treinamento comerciais;\r\nDesenvolver clientes atuais e prospectar novos parceiros;\r\nHabilidade de apresentações e uso de software.', 10, 50, 'Conhecer técnicas secretas da roça!', NULL, 'beneficios do auto sadf'),
(68, 'Agronomo', 'app/images/vagas/nature1.jpg', 'AgroNegócio SA', 'Formação Completa em Agronomia;\r\nExperiência em vendas comprovada nas culturas de Soja, Trigo e Feijão; Participação em eventos agrí­colas; \r\nParticipação no desenvolvimento de mercado em clientes e parceiros comerciais; \r\nDisponibilidade de viagens e treinamento comerciais;\r\nDesenvolver clientes atuais e prospectar novos parceiros;\r\nHabilidade de apresentações e uso de software.', 10, 50, 'Conhecer técnicas secretas da roça!', NULL, 'beneficios do auto asdf'),
(69, 'nature4', 'app/images/vagas/nature4.jpg', 'empresanature', 'requisitos nature', 44444.4, 300, 'descricao nature', 'FECHADA', 'beneficios nature'),
(70, NULL, 'app/images/vagas/', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
--
-- Indexes for table `area_de_interesse`
--
ALTER TABLE `area_de_interesse`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `area_e_curriculo`
--
ALTER TABLE `area_e_curriculo`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_area` (`areadeinteresses_id`),
  ADD KEY `fk_curriculo` (`curriculo_id`);
...
ALTER TABLE `candidato`
  ...
  ADD KEY `curriculo_id` (`curriculo_id`);
...
--
-- Indexes for table `cursos_complementares`
--
ALTER TABLE `cursos_complementares`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `id` (`id`),
  ADD KEY `curriculo_id` (`curriculo_id`);
...
--
-- Indexes for table `nivel_idioma`
--
...
--
-- AUTO_INCREMENT for table `area_de_interesse`
--
ALTER TABLE `area_de_interesse`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `area_e_curriculo`
--
ALTER TABLE `area_e_curriculo`
...
--
ALTER TABLE `cidade`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5565;
--
...
--
-- AUTO_INCREMENT for table `cursos_complementares`
--
ALTER TABLE `cursos_complementares`
...
--
-- AUTO_INCREMENT for table `nivel_idioma`
--
ALTER TABLE `nivel_idioma`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
--
...
--
ALTER TABLE `candidato`
  ADD CONSTRAINT `candidato_ibfk_1` FOREIGN KEY (`cidade_id`) REFERENCES `cidade` (`id`),
  ADD CONSTRAINT `candidato_ibfk_2` FOREIGN KEY (`curriculo_id`) REFERENCES `curriculo` (`id`);
...
--
-- Limitadores para a tabela `cursos_complementares`
--
ALTER TABLE `cursos_complementares`
  ADD CONSTRAINT `cursos_complementares_ibfk_1` FOREIGN KEY (`curriculo_id`) REFERENCES `curriculo` (`id`);

--
-- Limitadores para a tabela `experiencia_profissional`
--
ALTER TABLE `experiencia_profissional`
  ADD CONSTRAINT `experiencia_profissional_ibfk_1` FOREIGN KEY (`curriculo_id`) REFERENCES `curriculo` (`id`);

--
-- Limitadores para a tabela `formacao`
--
ALTER TABLE `formacao`
  ADD CONSTRAINT `fk_formacao_cursos` FOREIGN KEY (`curso_id`) REFERENCES `cursos` (`id`),
  ADD CONSTRAINT `formacao_ibfk_1` FOREIGN KEY (`curriculo_id`) REFERENCES `curriculo` (`id`);

--
-- Limitadores para a tabela `nivel_idioma`
--
ALTER TABLE `nivel_idioma`
  ADD CONSTRAINT `nivel_idioma_ibfk_1` FOREIGN KEY (`idioma_id`) REFERENCES `idioma` (`id`),
  ADD CONSTRAINT `nivel_idioma_ibfk_2` FOREIGN KEY (`curriculo_id`) REFERENCES `curriculo` (`id`);
COMMIT;
