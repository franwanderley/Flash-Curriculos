...
class VagaDetalhesFuncionario extends TPage{
    private $vaga;
    private $form;
    private $form_editar;
    private $datagrid;
    ...
    public function __construct(){
        ...
        if ( TSession::getValue('tipo_usuario') == 'CANDIDATO' || TSession::getValue('tipo_usuario') == 'ADMINISTRADOR' || TSession::getValue('tipo_usuario') == NULL) {
        ...
        if (array_key_exists('key', $_GET)) {
            TSession::setValue('VagasFormFunc_vaga_id', $_GET['key']);
            
            $this->vagaId = $_GET['key'];
        }else {
            if ( TSession::getValue('VagasFormFunc_vaga_id')){ // Se vier da classe VagasForm
                $this->vagaId = TSession::getValue('VagasFormFunc_vaga_id');
